export const PUBLICATION_MANIFESTS = {
  ...
  "thorium-reader-user-guide-english":
  ...
  "thorium-reader-user-guide-french":
  ...
  "thorium-reader-user-guide-spanish":
  ...
  "Fundamental-Accessibility-Tests-Basic-Functionality-v2.0.0":
  ...
  "Fundamental-Accessibility-Tests-Non-Visual-Reading-v2.0.1":
  ...
  "Fundamental-Accessibility-Tests-Visual-Adjustments-v2.0.0":
  ...
  "Advanced-Accessibility-Tests-Media-Overlays-v1.0.0":
  ...
  "Accessibility-Tests-Extended-Descriptions-v1.1.1":
  ...
  "the-martian":
    "http://localhost:8100/webpub/ZmlsZTovLy9BbmR5IFdlaXIgLSBUaGUgTWFydGlhbi5tcDM/manifest.json",
  "harry-potter-and-the-order-of-the-phoenix":
    "http://localhost:8008/webpub/Si5LLiBSb3dsaW5nIC0gSGFycnkgUG90dGVyIGFuZCB0aGUgSGFsZi1CbG9vZCBQcmluY2UgKDEpLm00Yg/manifest.json",
  "a-cadet-becomes-a-prophet":
    "http://localhost:15080/webpub/QSBDYWRldCBCZWNvbWVzIGEgUHJvcGhldF8h/manifest.json",
  "aces-abroad": "http://localhost:15080/webpub/QWNlcyBBYnJvYWQ/manifest.json",
  "harry-potter-and-the-chamber-of-secrets":
    "http://localhost:15080/webpub/Si5LLiBSb3dsaW5nL0hhcnJ5IFBvdHRlciBhbmQgdGhlIENoYW1iZXIgb2YgU2VjcmV0cw/manifest.json",
  "harry-potter-and-the-chamber-of-secrets-full-cast-edition":
    "http://localhost:15080/webpub/Si5LLiBSb3dsaW5nL0hhcnJ5IFBvdHRlciBhbmQgdGhlIENoYW1iZXIgb2YgU2VjcmV0cyAoRnVsbC1DYXN0IEVkaXRpb24p/manifest.json",
  "the-christmas-pig":
    "http://localhost:15080/webpub/Si5LLiBSb3dsaW5nL1RoZSBDaHJpc3RtYXMgUGln/manifest.json",
  "the-ickabog":
    "http://localhost:15080/webpub/Si5LLiBSb3dsaW5nL1RoZSBJY2thYm9n/manifest.json",
