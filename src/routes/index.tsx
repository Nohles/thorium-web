...
const books = [
  { title: "Moby Dick", author: "Herman Melville", cover: "/images/MobyDick.jpg", url: "/read/moby-dick", rendition: "Reflowable EPUB" },
...
const webPublications = [
  { title: "Readium CSS Implementers’ Documentation", author: "Jiminy Panoz", cover: "/images/readium-css.jpg", url: "/read/readium-css", rendition: "Web Publication" },
];
...
function Home() {
  ...
  useEffect(() => {
    isManifestRouteEnabledOnServer().then(setIsManifestEnabled).catch(() => setIsManifestEnabled(false));
  }, []);
    ...
    <main id="home">
      ...
      <PublicationGrid
        ...
        renderCover={(publication) => (
          <img src={publication.cover} alt="" loading="lazy" width={120} height={180} />
        )}
      />
